                  ...
                  // appendHtml += '<div class="user_upload_part_section_content">';
                    for (i = 0; i < jsObject.uploaddetails.length; i++) {
                        if(jsObject.uploaddetails[i].uploadType == "video"){
                             ...
                             appendHtml +='<li class="gs-w user_upload_part_section_content--inside vid-sec text-sec resizable previewUploadedFile" data-col="1" data-row="1" data-cmd="text" data-sizey="'+jsObject.uploaddetails[i].sizeY+'" data-sizex="'+jsObject.uploaddetails[i].sizeX+'" data-id="'+jsObject.uploaddetails[i].uploadId+'"><span><label name="text Name">'+jsObject.uploaddetails[i].uploadPath+'</label></span><div class="inner-box"> 0 </div><input type="hidden" class="uploadId" value="'+jsObject.uploaddetails[i].uploadId+'"></li>';
                        } else{
