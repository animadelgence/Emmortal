<!-- line modal for text-->
<div class="modal fade" id="videoPreviewModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true" style="position: absolute !important;">
			...
			<div class="modal-body">
			    <div class="show-modal-video">
			     ...
			     <div class="show-adds-btns left">
			         ...
			         <div class="e-like btn e-btn btn-round full likeClick" style="background-color: rgb(180, 80, 78);" data-cmd="video" id="videoLikeCount">0</div>
			     </div>
